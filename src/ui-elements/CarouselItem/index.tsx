...
const CarouselItemContent = ({ carouselItemType, content, settings, alias, id, categoryTheme }: ICarouselItem) => {
  ...
  return (
    ...
    >
      <div
        className={`h-full min-h-96 relative shrink-0 lg:h-[700px] ${carouselItemType.includes(CAROUSEL_ITEM_TYPE.FULL_IMAGE_SQUARE) ? 'aspect-square w-full md:min-w-[500px]' : 'w-[768px] lg:w-[1024px]'}`}
      >
        <Image
